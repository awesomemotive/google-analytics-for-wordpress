...
<div class="tabwrapper">
	<div id="general" class="gatab">
		...
		echo Yoast_GA_Admin_Form::input( 'checkbox', __( 'Ignore users after logout', 'google-analytics-for-wordpress' ), 'ignore_loggedout_users', null, __( 'Users of the role you selected above will be ignored after logout from WordPress, so if you select Editor, all Editors will be ignored.', 'google-analytics-for-wordpress' ) );
