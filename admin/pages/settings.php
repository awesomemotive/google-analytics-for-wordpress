...
<div class="tabwrapper">
	...
	<div id="advanced" class="gatab">
		...
		/* translators: 1: link to the Google Analytics help page on Google.com to set subdomain tracking. 2: link closing tag */
		...
		/* translators: 1: link to the Google Analytics help page on Google.com to track internal links as outbound links. 2: link closing tag */
		...
		/* translators: 1: link to the Google Analytics help page on Google.com to enable link attribution. 2: link closing tag */
