...
?>
	<div class="tabwrapper">
		<div id="general" class="gatab">
			...
			echo $yoast_ga_admin->select( 'Analytics profile', 'analytics_profile', $yoast_ga_admin->get_profiles(), 1432 );
		...
		<div id="advanced" class="gatab">
			...
			echo $yoast_ga_admin->select( 'Track downloads as', 'track_download_as', $yoast_ga_admin->track_download_types(), 1 );
			echo $yoast_ga_admin->input( 'text', 'Extensions of files to track as downloads', 'extensions_of_files', NULL, 'Comma separated' );
			echo $yoast_ga_admin->select( 'Track full URL of outbound clicks or just the domain', 'track_full_url', $yoast_ga_admin->get_track_full_url(), 0 );
