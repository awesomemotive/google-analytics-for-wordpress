...
<div class="tabwrapper">
	<div id="general" class="gatab">
		...
		echo Yoast_GA_Admin_Form::input( 'checkbox', __( 'Disable dashboards functionality', 'google-analytics-for-wordpress' ), 'dashboards_disabled', null, __( 'The Google Analytics dashboards can be disabled and we stop with aggregating analytics data from your Google account when this setting is enabled.', 'google-analytics-for-wordpress' ) );
		?>
	</div>
