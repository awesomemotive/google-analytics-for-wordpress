...
<div class="tabwrapper">
	...
	<div id="advanced" class="gatab">
		...
		echo Yoast_GA_Admin_Form::input( 'text', __( 'Label for those links', 'google-analytics-for-wordpress' ), 'track_internal_as_label', null, sprintf( __( 'The label to use for these links, this will be added to where the click came from, so if the label is "%1$s", the label for a click from the content of an article becomes "%2$s".', 'google-analytics-for-wordpress' ), 'aff', 'outbound-article-aff' ) );
