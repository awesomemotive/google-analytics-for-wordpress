...
<div class="tabwrapper">
	...
	<div id="universal" class="gatab">
		...
		echo Yoast_GA_Admin_Form::input(
			'checkbox',
			__( 'Enable Remarketing and Advertising (also Demographics and Interests) Reporting Features', 'google-analytics-for-wordpress' ),
			'demographics',
