...
<div class="tabwrapper">
	...
	<div id="advanced" class="gatab">
		...
		echo Yoast_GA_Admin_Form::input( 'text', __( 'JS object name', 'google-analytics-for-wordpress' ), 'js_object_name', null, __( 'Not for the average user: this allows you to rename the front-end name of the Google Analytics JavaScript object.', 'google-analytics-for-wordpress' ) );
