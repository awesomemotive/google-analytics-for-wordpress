...
<div class="tabwrapper">
	...
	<div id="universal" class="gatab">
		...
		echo Yoast_GA_Admin_Form::input( 'checkbox', __( 'Track user ID', 'google-analytics-for-wordpress' ), 'track_user_id', null, sprintf( __( 'This adds an extra tracking code if the user is logged in, so you can track the User IDs in Google Analytics.', 'google-analytics-for-wordpress' ), '<a href="https://developers.google.com/analytics/devguides/collection/gajs/methods/gaJSApiCampaignTracking?csw=1#_gat.GA_Tracker_._setAllowAnchor" target="_blank"><code>_setAllowAnchor</code></a>', '<code>#</code>' ) );
		?>
	</div>
