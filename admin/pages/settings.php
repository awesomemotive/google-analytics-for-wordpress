...
<div class="tabwrapper">
	...
	<div id="universal" class="gatab">
		...
		echo Yoast_GA_Admin_Form::input(
			...
			/* translators: %1$s contains the link to a knowledge base article, %2$s contains the the closing tag for both links, %3$s contains a link to Google documentation about remarketing. */
			sprintf(
		...
		/* translators: %1$s is a link to the Google Analytics help page on Google.com to enable link attribution, %2$s is the closing tag */
	...
	<div id="advanced" class="gatab">
		...
		/* translators: %1$s is a link to the Google Analytics help page on Google.com to set subdomain tracking, %2$s is the closing tag */
		...
		/* translators: %1$s is a link to the Google Analytics help page on Google.com to track internal links as outbound links, %2$s is the closing tag */
		...
		/* translators: %1$s is a link to the Google Analytics help page on Google.com add the allow linker tag, %2$s is the closing tag */
		...
		/* translators: %1$s is a link to the Google Analytics help page on Google.com to add custom code for the tracking, %2$s is the closing tag */
