...
if ( ! class_exists( 'Yoast_GA_Admin' ) ) {
	...
	class Yoast_GA_Admin extends Yoast_GA_Options {
		...
		public function create_admin_menu() {
			...
			// Add main page
			add_menu_page( __( 'Yoast Google Analytics:', 'google-analytics-for-wordpress' ) . ' ' . __( 'General Settings', 'google-analytics-for-wordpress' ), __( 'Analytics', 'google-analytics-for-wordpress' ), 'manage_options', 'yst_ga_' . $menu_name, array(
				$this,
				'load_page',
