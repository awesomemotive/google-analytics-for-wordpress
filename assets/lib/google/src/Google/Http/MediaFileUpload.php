 ...
 * of sizable data.
 */
class MonsterInsights_GA_Lib_Http_MediaFileUpload
{
  ...
  /** @var MonsterInsights_GA_Lib_Http_Request */
  private $request;
  ...
  public function __construct(
      ...
      MonsterInsights_GA_Lib_Http_Request $request,
      $mimeType,
      $data,
      $resumable = false,
      $chunkSize = false,
  ...
  */
  private function makePutRequest(MonsterInsights_GA_Lib_Http_Request $httpRequest)
  {
    ...
    if (308 == $code) {
      ...
      return MonsterInsights_GA_Lib_Http_REST::decodeHttpResponse($response, $this->client);
    }
  }
  ...
  private function fetchResumeUri()
  {
    ...
    if ($body) {
      $headers = array(
        ...
        'content-length' => MonsterInsights_GA_Lib_Utils::getStrLen($body),
    ...
    throw new MonsterInsights_GA_Lib_Exception($error);
  }
