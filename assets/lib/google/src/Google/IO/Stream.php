...
class MonsterInsights_GA_Lib_IO_Stream extends MonsterInsights_GA_Lib_IO_Abstract
{
  ...
  public function executeRequest(MonsterInsights_GA_Lib_Http_Request $request)
  {
    ...
    if ($this->trappedErrorNumber) {
      ...
      throw new MonsterInsights_GA_Lib_IO_Exception($error, $this->trappedErrorNumber);
    }
    ...
    if (false === $response_data) {
      ...
      $this->client->getLogger()->error('Stream ' . $error);
      throw new MonsterInsights_GA_Lib_IO_Exception($error, $respHttpCode);
    }
