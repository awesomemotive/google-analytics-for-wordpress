 ...
 */
class MonsterInsights_GA_Lib_Config
{
  ...
  /**
   * Create a new MonsterInsights_GA_Lib_Config. Can accept an ini file location with the
  ...
  public function __construct($ini_file_location = null)
  {
    $this->configuration = array(
      ...
      'auth_class'    => 'MonsterInsights_GA_Lib_Auth_OAuth2',
      'io_class'      => self::USE_AUTO_IO_SELECTION,
      'cache_class'   => 'MonsterInsights_GA_Lib_Cache_File',
      'logger_class'  => 'MonsterInsights_GA_Lib_Logger_Null',
      ...
      'classes' => array(
        'MonsterInsights_GA_Lib_IO_Abstract' => array(
          'request_timeout_seconds' => 100,
        ),
        'MonsterInsights_GA_Lib_IO_Curl' => array(
          'disable_proxy_workaround' => false,
          'options' => null,
        ),
        'MonsterInsights_GA_Lib_Logger_Abstract' => array(
          'level' => 'debug',
          'log_format' => "[%datetime%] %level%: %message% %context%\n",
          'date_format' => 'd/M/Y:H:i:s O',
          'allow_newlines' => true
        ),
        'MonsterInsights_GA_Lib_Logger_File' => array(
          'file' => 'php://stdout',
          'mode' => 0640,
          'lock' => false,
        ),
        'MonsterInsights_GA_Lib_Http_Request' => array(
        ...
        'MonsterInsights_GA_Lib_Auth_OAuth2' => array(
        ...
        'MonsterInsights_GA_Lib_Task_Runner' => array(
        ...
        'MonsterInsights_GA_Lib_Service_Exception' => array(
          'retry_map' => array(
        ...
        'MonsterInsights_GA_Lib_IO_Exception' => array(
        ...
        'MonsterInsights_GA_Lib_Cache_File' => array(
          'directory' => sys_get_temp_dir() . '/MonsterInsights_GA_Lib_Client'
        )
      ),
    );
   ...
   * the hd values within an id token (@see MonsterInsights_GA_Lib_Auth_LoginTicket) after sign
