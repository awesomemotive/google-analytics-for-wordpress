 ...
 */
class MonsterInsights_GA_Lib_Cache_File extends MonsterInsights_GA_Lib_Cache_Abstract
{
  ...
  public function delete($key)
  {
    ...
    if (file_exists($file) && !unlink($file)) {
      ...
      throw new MonsterInsights_GA_Lib_Cache_Exception("Cache file could not be deleted");
    }
  ...
  private function getCacheDir($file, $forWrite)
  {
    ...
    if ($forWrite && ! is_dir($storageDir)) {
      if (! mkdir($storageDir, 0700, true)) {
        ...
        throw new MonsterInsights_GA_Lib_Cache_Exception("Could not create storage directory: $storageDir");
      }
    }
    return $storageDir;
  }
