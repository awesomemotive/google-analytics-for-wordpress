 ...
 */
class MonsterInsights_GA_Lib_Cache_Apc extends MonsterInsights_GA_Lib_Cache_Abstract
{
  /**
  ...
  public function set($key, $value)
  {
    ...
    if ($rc == false) {
      ...
      throw new MonsterInsights_GA_Lib_Cache_Exception("Couldn't store data");
    }
