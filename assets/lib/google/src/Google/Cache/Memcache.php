 ...
 */
class MonsterInsights_GA_Lib_Cache_Memcache extends MonsterInsights_GA_Lib_Cache_Abstract
{
  ...
  /**
   * @var MonsterInsights_GA_Lib_Client the current client
   */
  private $client;
  ...
  public function __construct(MonsterInsights_GA_Lib_Client $client)
  {
    if (!function_exists('memcache_connect') && !class_exists("Memcached")) {
      ...
      throw new MonsterInsights_GA_Lib_Cache_Exception($error);
    }
   ...
   * @param string $key
   * @param string $value
   * @throws MonsterInsights_GA_Lib_Cache_Exception
   */
  public function set($key, $value)
  {
    ...
    if ($rc == false) {
      ...
      throw new MonsterInsights_GA_Lib_Cache_Exception("Couldn't store data in cache");
    }
