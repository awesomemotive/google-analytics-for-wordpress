 ...
 * with the `MonsterInsights_GA_Lib_Logger_Psr::setLogger()` method.
 */
class MonsterInsights_GA_Lib_Logger_Psr extends MonsterInsights_GA_Lib_Logger_Abstract
{
  /**
   ...
   */
  public function __construct(MonsterInsights_GA_Lib_Client $client, /*Psr\Log\LoggerInterface*/ $logger = null)
  {
