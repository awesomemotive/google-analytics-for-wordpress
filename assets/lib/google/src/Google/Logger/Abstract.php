 ...
 */
abstract class MonsterInsights_GA_Lib_Logger_Abstract
{
  /**
   * Default log format
   */
  ...
  /**
   * @param MonsterInsights_GA_Lib_Client $client  The current Google client
   */
  public function __construct(MonsterInsights_GA_Lib_Client $client)
  {
    $this->setLevel(
        $client->getClassConfig('MonsterInsights_GA_Lib_Logger_Abstract', 'level')
    );

    $format = $client->getClassConfig('MonsterInsights_GA_Lib_Logger_Abstract', 'log_format');
    $this->logFormat = $format ? $format : self::DEFAULT_LOG_FORMAT;

    $format = $client->getClassConfig('MonsterInsights_GA_Lib_Logger_Abstract', 'date_format');
    $this->dateFormat = $format ? $format : self::DEFAULT_DATE_FORMAT;

    $this->allowNewLines = (bool) $client->getClassConfig(
        'MonsterInsights_GA_Lib_Logger_Abstract',
        'allow_newlines'
    );
  }
   ...
   * @throws MonsterInsights_GA_Lib_Logger_Exception If $level is invalid
   */
