 ...
 */
class MonsterInsights_GA_Lib_Logger_File extends MonsterInsights_GA_Lib_Logger_Abstract
{
  /**
  ...
  public function __construct(MonsterInsights_GA_Lib_Client $client)
  {
    ...
    $this->lock = (bool) $client->getClassConfig('MonsterInsights_GA_Lib_Logger_File', 'lock');
    $this->file = $file;
  }
