...
S2.define('select300/compat/utils',[
  'jquery'
], function ($) {
...
S2.define('select300/compat/containerCss',[
  'jquery',
  './utils'
...
S2.define('select300/compat/dropdownCss',[
  'jquery',
  './utils'
], function ($, CompatUtils) {
  // No-op CSS adapter that discards all classes by default
...
S2.define('select300/compat/initSelection',[
  'jquery'
], function ($) {
...
S2.define('select300/compat/inputData',[
  'jquery'
], function ($) {
...
S2.define('select300/compat/matcher',[
  'jquery'
], function ($) {
...
S2.define('select300/compat/query',[
...
S2.define('select300/dropdown/attachContainer',[
  ...
  AttachContainer.prototype.position =
    ...
    $dropdown.addClass('select300-dropdown--below');
    $container.addClass('select300-container--below');
  };

  return AttachContainer;
});

S2.define('select300/dropdown/stopPropagation',[
...
S2.define('select300/selection/stopPropagation',[
