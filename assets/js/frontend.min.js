...
else{if(!e.defaultPrevented){e.preventDefault?e.preventDefault():e.returnValue=!1};if(i=="download"){if(p=="pageview"){if(!a){__gaTracker("send","pageview",t,{"hitCallback":r})}
