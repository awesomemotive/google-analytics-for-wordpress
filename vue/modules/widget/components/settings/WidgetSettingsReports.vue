<template>
	<div class="monsterinsights-widget-dropdown">
		...
		<div v-if="dropdownVisible" v-click-outside="hideDropdown" class="monsterinsights-widget-dropdown-content">
			...
			>
				<label :class="report.enabled ? 'monsterinsights-checked' : ''" tabindex="0" v-on:click.prevent="toggleReport( $event, key)" v-on:keyup.enter="toggleReport( $event, key)" v-on:keyup.space="toggleReport( $event, key)">
