...
class Yoast_GA_Admin_Form_Fields_Test extends GA_UnitTestCase {
	...
	public function test_yst_ga_text_field_WITH_no_value() {
		...
		$expected = '<input type="text" name="yst_ga_settings[ga_general][' . $args['key'] . ']" value="" class="ga-form-text">';
	...
	public function test_yst_ga_textarea_field_WITH_no_value() {
		...
		$expected = '<textarea name="yst_ga_settings[ga_general][' . $args['key'] . ']" rows="5" cols="60"></textarea>';
	...
	public function test_yst_ga_checkbox_field_WITH_no_value() {
		...
		$expected = '<input type="checkbox" name="yst_ga_settings[ga_general][' . $args['key'] . ']" value="1" >';
